        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-5 mb-6">
          ...
          <form
            onSubmit={async (e) => {
              ...
              try {
                const response = await fetch('http://127.0.0.1:5185/upload-policies', {
                  method: 'POST',
                ...
                alert('Connection to background daemon failed. Ensure the daemon server is running on port 5185.');
              }
            }}
